import { aws_certificatemanager, aws_route53, NestedStack, NestedStackProps } from 'aws-cdk-lib'
...
export class Certificate extends NestedStack {
  ...
  constructor(scope: Construct, id: string, props: CertificateProps) {
    ...
    this.certificate = new aws_certificatemanager.Certificate(this, 'some-api-certificate', {
      domainName,
